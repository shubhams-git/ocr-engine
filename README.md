...
This comprehensive documentation covers the complete OCR-based Financial Projection System - a sophisticated 4-stage AI-powered platform that transforms financial documents into accurate, validated financial forecasts. The system combines document processing, business intelligence, and advanced financial modeling to deliver professional-grade projections.
...
4.  **Stage 3 & 3.5**: Master the [Projection Engine](04-stage3-projection-engine.md)
...
**Extraction Service & Data Processing**
...
### 3. [Stage 2: Business Analysis & Cash Flow Generation](03-stage2-business-analysis.md)

**Cash Flow Service & Business Intelligence**
...
### 4. [Stage 3 & 3.5: Projection Engine & Strategic Enhancement](04-stage3-projection-engine.md)

**Financial Analysis, Enhancement & Forecasting**

*   Integrated P&L, Cash Flow, Balance Sheet
*   Strategic Enhancement with external factor analysis
*   Calculation chain transparency
*   Multi-horizon projections (1, 3, 5, 10, 15 years)
*   Scenario planning (Base Case vs. Enhanced Case)
...
*   **Gemini 2.5 Pro**: Complex business analysis and projections (Stages 2-4)
...
*   **Strategic Enhancement**: Incorporates external factors and strategic insights
...
graph TD
    ...
    F --> G[Validation Framework]
    G --> H[Financial Projections]
    ...
    J --> E
    J --> F
    K[Local Validation] --> G
    L[AI Semantic Validation] --> G
```
...
3.  **Cash Flow Generation**: Reconstruction of historical cash flows (Stage 2 - Pro)
4.  **Business Analysis**: Context analysis and methodology selection (Stage 3 - Pro)
5.  **Strategic Enhancement**: Incorporation of external factors and strategic insights (Stage 3.5 - Pro)
6.  **Projection Generation**: 3-way forecast creation (Stage 4 - Pro)
7.  **Quality Validation**: Multi-layer validation and quality scoring
8.  **Output Delivery**: Comprehensive financial projections with metadata
...
*   **Images**: Up to 10MB, scanned documents (PNG, JPG, GIF, BMP, TIFF, WEBP) - via extraction endpoint only
...
*   **Stage 2-4 (Analysis)**: Gemini 2.5 Pro - complex reasoning and financial modeling
...
*   **Scenarios**: Optimistic, Base Case, Enhanced Case, Conservative projections
...
2.  [Stage Documentation](02-stage1-data-extraction.md) - Deep technical dive
...
*   **Image Format Support**: Full integration of image processing into multi-file workflow
